 ...
 */
?>
<div id="wide-header-top">
    <div id="wide-header-top-inner" class="clr container">
        <div id="top-section">
            <?php if (theme_get_setting('socialicon_display', 'multipurpose')): ?>
              ...
              $rss_url = check_plain(theme_get_setting('rss_url', 'multipurpose'));
              ?>
              <div id="header-social" class="clr">
                  <ul>
                      ...
                      <?php if ($rss_url): ?><li>
                            <a target="_blank" title="<?php print $site_name; ?> in RSS" href="<?php print $rss_url; ?>"><img alt="RSS" src="<?php print base_path() . drupal_get_path('theme', 'multipurpose') . '/images/social/rss.png'; ?>"> </a>
                        </li><?php endif; ?>
                  </ul>
              </div>
            <?php endif; ?>
            <?php if ($page['user_section']): ?>
              <aside id="user_section" class="user_section">
                  <?php print render($page['user_section']); ?>
              </aside> 
            <?php endif; ?>
        </div>
                ...
                <div id="site-name-slogan">
                    <div id="site-name">
                        <a href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>">
                            <img src="<?php print base_path() . drupal_get_path('theme', 'multipurpose') . '/images/name_red.png'; ?>" alt="<?php print $site_name; ?>">
                        </a>
                    </div>
                    <?php if ($site_slogan): ?>
                      <div id="site-slogan">
    ...
    <div id="site-navigation-wrap">
        ...
        <nav id="site-navigation" class="navigation main-navigation clr" role="navigation">
            <div id="main-menu" class="menu-main-container clr container">
                <?php
...
<div id="wide-footer-wrapper">
    <div id="wide-footer-wrapper-top">
        <div id="wide-footer-wrapper-inner-top" class="site-footer clr container">
    ...
    <div id="wide-footer-wrapper-bottom">
        <div id="wide-footer-wrapper-inner-bottom" class="clr container">
            <footer id="copyright-wrap" class="clear clr container">
                <div id="copyright"><?php print t('Copyright'); ?> &copy; <?php echo date("Y"); ?> - <a href="<?php print $front_page; ?>"><?php print $site_name; ?></a> | <?php print t('Projekt realizoval'); ?>  <a href="http://www.klepikov.cz/" title="Alexandr Klepikov" target="_blank">Alexandr Klepikov</a>.</div>
            </footer>
        </div>
    </div>
</div>